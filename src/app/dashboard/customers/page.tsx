            ...
            <Card className="border-none shadow-md">
                <CardHeader className="bg-muted/10 px-6 py-4">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        ...
                        <Button variant="ghost" className="gap-2 h-10 border border-muted-foreground/10 bg-background hover:bg-muted/50" onClick={() => toast.info("Filter sidebar opened")}>
                        ...
                        <Table className="min-w-[800px]">
                            ...
                            <TableBody>
                                {customers.map((customer) => (
                                    <TableRow key={customer.id} className="group hover:bg-muted/20 transition-colors border-b-muted/50 text-start">
                                        ...
                                        <TableCell className="px-6 py-4 text-right">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="w-40">
                                                    ...
                                                    <DropdownMenuItem onClick={() => toast.info(`Viewing ${customer.name}`)}>View Profile</DropdownMenuItem>
                                                    <DropdownMenuItem onClick={() => toast.info(`Editing ${customer.name}`)}>Edit Details</DropdownMenuItem>
                                                    <DropdownMenuSeparator />
                                                    <DropdownMenuItem
                                                        className="text-rose-500 focus:text-rose-500"
                                                        onClick={() => { setCustomerToDelete(customer.id); setIsDeleteDialogOpen(true); }}
                                                    >
            ...
            <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        <Button variant="destructive" onClick={handleDeleteCustomer}>Delete Permanent</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
        </div>
